...
class CountryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('keyword')) {
            $countries = Country::where('country_code', 'like', "%{$request->keyword}%")->orWhere('name', 'like',"%{$request->keyword}")->get();
        }
    ...
    {
        $country->delete();
        return redirect()->route('countries.index')->with('message', 'Data Deleted');
    }
}
